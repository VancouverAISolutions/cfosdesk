...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-100">
      {/* Top Bar */}
      <header className="bg-white border-b border-slate-200 px-6 py-0 flex items-center justify-between h-14 flex-shrink-0 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-xs text-slate-400">Franchise Operations Platform</span>
          </div>
        </div>
      ...
      <div className="flex flex-1 min-h-0">
        {/* Sidebar */}
        <aside className="w-56 bg-[#1e3a5f] flex-shrink-0 flex flex-col py-5 px-3">
